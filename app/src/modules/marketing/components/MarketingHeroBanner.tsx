...
export default function MarketingHeroBanner({ userName, bannerImageUrl }: MarketingHeroBannerProps) {
    ...
    return (
        <div className="relative w-full rounded-xl overflow-hidden mb-6" style={{ minHeight: 160 }}>
            {bannerImageUrl ? (
                ...
                <img src={bannerImageUrl} alt="Marketing Banner" className="absolute inset-0 w-full h-full object-cover" />
            ) : (
                <div className="absolute inset-0 bg-gradient-to-br from-rose-600 via-pink-500 to-fuchsia-500" />
            )}
