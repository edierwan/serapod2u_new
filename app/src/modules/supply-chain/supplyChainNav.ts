...
export const supplyChainNavGroups: SupplyChainNavGroup[] = [
    ...
    },
    {
        ...
        children: [
            ...
            { id: 'stock-adjustment', label: 'Stock Count', icon: SettingsIcon },
            { id: 'stock-opening-balance', label: 'Opening Balance', icon: Package },
...
export const supplyChainViewToPath: Record<string, string> = {
    ...
    'stock-opening-balance': 'inventory/opening-balance',
...
export const supplyChainPathToView: Record<string, string> = {
    ...
    'inventory/opening-balance': 'stock-opening-balance',
