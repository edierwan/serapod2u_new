...
export default function LoyaltyHeroBanner({ userName, bannerImageUrl }: LoyaltyHeroBannerProps) {
    ...
    return (
        <div className="relative w-full rounded-xl overflow-hidden mb-6" style={{ minHeight: 160 }}>
            ...
            {bannerImageUrl ? (
                ...
                /* Default gradient background – purple/violet theme for Loyalty */
                <div className="absolute inset-0 bg-gradient-to-br from-purple-600 via-violet-500 to-fuchsia-500" />
            )}
