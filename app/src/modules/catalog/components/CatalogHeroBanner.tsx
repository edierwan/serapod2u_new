...
export default function CatalogHeroBanner({ userName, bannerImageUrl }: CatalogHeroBannerProps) {
    ...
    return (
        <div className="relative w-full rounded-xl overflow-hidden mb-6" style={{ minHeight: 160 }}>
            {bannerImageUrl ? (
                ...
                <img src={bannerImageUrl} alt="Catalog Banner" className="absolute inset-0 w-full h-full object-cover" />
            ) : (
                <div className="absolute inset-0 bg-gradient-to-br from-indigo-600 via-blue-500 to-cyan-500" />
            )}
