...
export default async function WhatsAppActivityRecoveryPage() {
  ...
  return <DashboardContent userProfile={userProfile} initialView="notifications/whatsapp-activity-recovery" />
}
