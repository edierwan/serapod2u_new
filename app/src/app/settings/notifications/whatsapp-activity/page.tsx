...
export default async function SettingsWhatsAppActivityPage() {
    ...
    return <DashboardContent userProfile={userProfile} initialView="settings/notifications/whatsapp-activity" />
}
