...
export default async function SettingsNotificationProvidersPage() {
    ...
    return <DashboardContent userProfile={userProfile} initialView="settings/notifications/providers" />
}
