...
export default async function SettingsDocumentTemplatePage() {
    ...
    return <DashboardContent userProfile={userProfile} initialView="settings/preferences/document-template" />
}
