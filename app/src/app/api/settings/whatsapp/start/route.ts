/**
 * WhatsApp Gateway Start Session API
 * 
 * POST /api/settings/whatsapp/start
 * Starts a new Baileys session after logout+clear for change-number flow
 * 
 * Uses legacy gateway endpoint: POST /session/start
 */
...
export async function POST(request: NextRequest) {
    try {
        ...
        // Call the start endpoint (single-flight locked)
