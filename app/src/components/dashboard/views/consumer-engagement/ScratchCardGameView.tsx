...
import { Plus, Search, Filter, Edit, Eye, Copy, Trash2, Gift } from 'lucide-react'
    ...
    return (
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    <h2 className="text-3xl font-bold tracking-tight">Scratch Card Game</h2>
                    <p className="text-muted-foreground">
                        Create and manage scratch card campaigns. Consumers can scratch to reveal random gifts when this feature is enabled in their journey.
                    </p>
                </div>
