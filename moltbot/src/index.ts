...
// ========== Draft API Endpoints (for Serapod UI) ==========

// Generate AI draft
app.post('/api/draft/:tenantId/:phone', (req, res) => webhookHandler.generateDraft(req, res));
app.post('/api/draft/:phone', (req, res) => webhookHandler.generateDraft(req, res));

// Send pending draft
app.post('/api/draft/:tenantId/:phone/send', (req, res) => webhookHandler.sendDraft(req, res));
app.post('/api/draft/:phone/send', (req, res) => webhookHandler.sendDraft(req, res));
