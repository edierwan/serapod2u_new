...
echo "🚀 Applying Fix Allocation Constraints Migration..."
echo ""
...
MIGRATION_FILE="$SCRIPT_DIR/supabase/migrations/087_fix_allocation_constraints.sql"
...
echo "📋 Migration file: 087_fix_allocation_constraints.sql"
