...
echo "🚀 Applying Fix Allocation Logic V2 Migration..."
echo ""
...
MIGRATION_FILE="$SCRIPT_DIR/supabase/migrations/089_fix_alloc_logic_v2.sql"
...
echo "📋 Migration file: 089_fix_alloc_logic_v2.sql"
