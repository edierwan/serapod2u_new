...
echo "🚀 Applying Fix Order Movement V4 Migration..."
echo ""
...
MIGRATION_FILE="$SCRIPT_DIR/supabase/migrations/091_fix_order_movement_v4.sql"
...
echo "📋 Migration file: 091_fix_order_movement_v4.sql"
