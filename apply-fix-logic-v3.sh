...
echo "🚀 Applying Fix Allocation Logic V3 Migration..."
echo ""
...
MIGRATION_FILE="$SCRIPT_DIR/supabase/migrations/090_fix_alloc_logic_v3.sql"
...
echo "📋 Migration file: 090_fix_alloc_logic_v3.sql"
