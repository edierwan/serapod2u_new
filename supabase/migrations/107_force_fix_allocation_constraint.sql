-- Migration: Force Fix Allocation Constraints
-- Description: Update valid_quantity_change constraint to allow positive allocation
--              This is a re-application of 087_fix_allocation_constraints.sql
...
BEGIN
    ...
    -- allocation: positive (increasing quantity_allocated) OR negative (if used for other purposes)
    -- We allow positive allocation here.
