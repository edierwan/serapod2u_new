-- Migration: Fix Warranty Bonus Cost Logic
-- Description: Ensure warranty_bonus always has 0 cost and updates average cost correctly.
...
BEGIN
    ...
    IF p_movement_type = 'warranty_bonus' THEN
        v_final_unit_cost := 0;
    ELSE
