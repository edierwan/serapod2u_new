-- ============================================================================
-- PRODUCTION: RoadTour Event (roadtour_runs) schema enhancement
-- ⚠ MANUAL RUN ONLY. NOT EXECUTED BY CODER AI.
-- ⚠ Run AFTER production_cleanup_roadtour_transactions.sql.
-- ⚠ Verify production_cleanup has confirmed zero rows in roadtour_campaigns
--    before running, otherwise the NOT NULL step will skip (and the column
--    will remain nullable until backfilled).
-- ============================================================================
