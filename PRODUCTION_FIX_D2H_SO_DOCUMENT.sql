...
BEGIN
  ...
  IF v.order_type IN ('D2H', 'S2D') THEN
      ...
      -- doc_no uses legacy order_no format (e.g., SO-ORD-DH-0126-11)
      -- display_doc_no is auto-generated by trigger (e.g., SO26000014)
...
-- doc_no uses legacy format (SO-ORD-DH-YYMM-XX), display_doc_no uses order's display_doc_no
INSERT INTO public.documents (
    company_id, 
    order_id, 
    doc_type, 
